...
namespace TimeRecordingApp.Cmds
{
    public class AddTimeRecordCommand : CommandBase
    {
        ...
        public override bool CanExecute(object parameter) => parameter is ObservableCollection<TimeRecordings>;

        public override void Execute(object parameter)
        {
            if ( ! (parameter is ObservableCollection<TimeRecordings> timeRecords)) return;
